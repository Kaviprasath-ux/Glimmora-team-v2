  ...
  <div className="flex items-center gap-3">
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          "pointer-events-none block h-5 w-5 rounded-full bg-white shadow-warm-sm transition-transform duration-200",
          "data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
        )}
      />
    </SwitchPrimitive.Root>
    {label && <span className="text-sm text-text-deep">{label}</span>}
  </div>
));
